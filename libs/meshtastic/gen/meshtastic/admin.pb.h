...
X(a, STATIC,   ONEOF,    INT32,    (payload_variant,nodedb_reset,payload_variant.nodedb_reset), 100) \
...
#define MESHTASTIC_MESHTASTIC_ADMIN_PB_H_MAX_SIZE meshtastic_KeyVerificationAdmin_size
