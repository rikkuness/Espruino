...
#define meshtastic_User_init_default             {{{NULL}, NULL}, {{NULL}, NULL}, {{NULL}, NULL}, {{NULL}, NULL}, _meshtastic_HardwareModel_MIN, 0, _meshtastic_Config_DeviceConfig_Role_MIN, {{NULL}, NULL}, false, 0}
#define meshtastic_RouteDiscovery_init_default   {{{NULL}, NULL}, {{NULL}, NULL}, {{NULL}, NULL}, {{NULL}, NULL}}
#define meshtastic_Routing_init_default          {0, {meshtastic_RouteDiscovery_init_default}}
#define meshtastic_Data_init_default             {_meshtastic_PortNum_MIN, {{NULL}, NULL}, 0, 0, 0, 0, 0, 0, false, 0}
#define meshtastic_KeyVerification_init_default  {0, {{NULL}, NULL}, {{NULL}, NULL}}
#define meshtastic_Waypoint_init_default         {0, false, 0, false, 0, 0, 0, {{NULL}, NULL}, {{NULL}, NULL}, 0}
...
#define meshtastic_DeviceMetadata_init_default   {{{NULL}, NULL}, 0, 0, 0, 0, 0, _meshtastic_Config_DeviceConfig_Role_MIN, 0, _meshtastic_HardwareModel_MIN, 0, 0, 0}
...
#define meshtastic_User_init_zero                {{{NULL}, NULL}, {{NULL}, NULL}, {{NULL}, NULL}, {{NULL}, NULL}, _meshtastic_HardwareModel_MIN, 0, _meshtastic_Config_DeviceConfig_Role_MIN, {{NULL}, NULL}, false, 0}
#define meshtastic_RouteDiscovery_init_zero      {{{NULL}, NULL}, {{NULL}, NULL}, {{NULL}, NULL}, {{NULL}, NULL}}
#define meshtastic_Routing_init_zero             {0, {meshtastic_RouteDiscovery_init_zero}}
#define meshtastic_Data_init_zero                {_meshtastic_PortNum_MIN, {{NULL}, NULL}, 0, 0, 0, 0, 0, 0, false, 0}
#define meshtastic_KeyVerification_init_zero     {0, {{NULL}, NULL}, {{NULL}, NULL}}
#define meshtastic_Waypoint_init_zero            {0, false, 0, false, 0, 0, 0, {{NULL}, NULL}, {{NULL}, NULL}, 0}
...
#define meshtastic_DeviceMetadata_init_zero      {{{NULL}, NULL}, 0, 0, 0, 0, 0, _meshtastic_Config_DeviceConfig_Role_MIN, 0, _meshtastic_HardwareModel_MIN, 0, 0, 0}
